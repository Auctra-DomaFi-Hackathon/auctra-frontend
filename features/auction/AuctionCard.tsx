  ...
  return (
    <Card
      className={cn(
        ...
        'hover:shadow-xl hover:-translate-y-1 border-blue-100/80',
    ...
    >
      ...
      <CardContent className="space-y-4">
        ...
        <div
          className={cn(
            'grid gap-3 rounded-xl border border-blue-100/80',
            'bg-blue-50/[0.35] p-3 sm:p-4',
        ...
        {/* ORACLE INFO */}
        <div className="text-[13px] sm:text-sm text-muted-foreground">
          Oracle Reserve: <span className="font-medium">{formatCurrency(domain.oracleReserveUsd)}</span>{' '}
          • Confidence:{' '}
          <span className="font-medium">{Math.round(domain.oracleConfidence * 100)}%</span>
        </div>
