...
export default function DomainCard({ domain }: DomainCardProps) {
  ...
  return (
    <Card className="bg-white dark:bg-neutral-900 border-gray-200 dark:border-neutral-800 hover:shadow-md transition-shadow duration-200">
      <CardContent className="p-4 sm:p-6">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex-1 sm:flex-initial">
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-neutral-100 break-all">
                  {domain.name}
                </h3>
                {domain.verified && (
        ...
        <div className="grid grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
          <div className="text-center">
            <div className="flex items-center justify-center gap-1 mb-2">
              ...
              <span className="text-xs text-gray-500 dark:text-neutral-400 sm:hidden">Value</span>
            </div>
            <p className="text-sm font-semibold text-gray-900 dark:text-neutral-100 break-all">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-1 mb-2">
              ...
              <span className="text-xs text-gray-500 dark:text-neutral-400">APR</span>
            </div>
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-1 mb-2">
              ...
              <span className="text-xs text-gray-500 dark:text-neutral-400 sm:hidden">Token</span>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <Button
            ...
            className="flex-1 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white text-sm sm:text-base py-2 sm:py-2.5"
          >
          ...
          <Button
            variant="outline"
            className="sm:px-4 px-3 text-sm sm:text-base py-2 sm:py-2.5 border-gray-300 dark:border-neutral-700 text-gray-700 dark:text-neutral-300 hover:bg-gray-50 dark:hover:bg-neutral-800"
          >
            Manage
          </Button>
        </div>
