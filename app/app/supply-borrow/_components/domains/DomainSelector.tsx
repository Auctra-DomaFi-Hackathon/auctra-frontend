...
export default function DomainSelector({ onDomainSelect, selectedDomain, disabled }: DomainSelectorProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Card className="border-dashed border-2 border-gray-300 hover:border-blue-400 hover:bg-blue-50/30 transition-colors cursor-pointer">
          <CardContent className="p-6">
            <div className="flex items-center justify-center gap-3 text-gray-600">
              <Globe className="h-8 w-8" />
              <div className="text-center">
                <p className="font-medium">Select Domain NFT</p>
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        {loading ? (
          <div className="flex items-center justify-center py-8">
            ...
            <span className="ml-2 text-gray-600">Loading your domains...</span>
          </div>
        ) : error ? (
          <div className="text-center py-8">
            <div className="text-red-600 mb-2">Failed to load domains</div>
