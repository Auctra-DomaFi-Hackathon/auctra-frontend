...
import StepDomain from "../create/_components/StepDomain";
import StepTerms from "../create/_components/StepTerms";
...
export default function NewListingForm() {
  ...
  const { actions, refetch } = useManageRentals();
    ...
    <div className="max-w-4xl">
      ...
      <Tabs value={currentStep} onValueChange={(v) => setCurrentStep(v as any)} className="w-full">
        ...
        <TabsContent value="domain">
          <StepDomain {...domainStepProps} />
        </TabsContent>

        <TabsContent value="terms">
          <StepTerms {...termsStepProps} />
        </TabsContent>

        <TabsContent value="preview">
          <StepPreview {...previewStepProps} />
        </TabsContent>
      </Tabs>
    </div>
  );
